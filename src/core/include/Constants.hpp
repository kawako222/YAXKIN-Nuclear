...
namespace Yaxkin {
    ...
    struct NuclearConstants {
        ...
        static constexpr double YIELD_PM    = 0.0113;
        static constexpr double LAMBDA_PM   = 3.56e-6;
        static constexpr double SIGMA_A_SM  = 4.1e-19;

        // --- SECCIÓN EFICAZ MACROSCÓPICA TOTAL DE ABSORCIÓN ---
        // Usada para normalizar la reactividad de venenos (PWR típico)
        static constexpr double SIGMA_A_TOTAL = 0.1;

        // --- SECCIÓN EFICAZ DE FISIÓN (PWR típico) ---
        static constexpr double SIGMA_F = 0.05;
